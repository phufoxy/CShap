<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CTHDADD1.aspx.cs" Inherits="QLTapHoaNTLTGroup.CTHDADD1" %>
        ...
        <section>
            ...
            <div id="table1">
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        <td class="call-to-action">
                            <asp:Label ID="Label2" runat="server" CssClass="auto-style4" Text="Tên Hàng Hóa"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td class="call-to-action">
                            <asp:Label ID="Label3" runat="server" CssClass="auto-style4" Text="Đơn Giá"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td class="call-to-action">
                            <asp:Label ID="Label4" runat="server" CssClass="auto-style4" Text="Số Lượng"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
