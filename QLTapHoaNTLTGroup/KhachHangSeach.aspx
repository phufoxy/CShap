...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td style="width: 319px">
            <asp:TextBox ID="TextBox4" runat="server" Width="306px" TextMode="Date" Enabled="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="width: 194px; text-align: right"><em><strong>
        ...
        <td style="width: 319px">
            <asp:TextBox ID="TextBox5" runat="server" Width="306px" Enabled="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="width: 194px; text-align: right"><em><strong>
        ...
        <td style="width: 319px">
            <asp:TextBox ID="TextBox6" runat="server" Width="306px" Enabled="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="width: 194px; text-align: right"><em><strong>
        ...
        <td style="width: 319px">
            <asp:TextBox ID="TextBox7" runat="server" Width="306px" Enabled="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="width: 194px; text-align: right"><em><strong>
        ...
        <td style="width: 319px">
            <asp:TextBox ID="TextBox8" runat="server" Width="306px" Enabled="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        ...
        <td class="call-to-action" style="width: 319px; text-align: left;">
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/anh/active-search.png" Width="26px" OnClick="ImageButton1_Click" />
        </td>
    </tr>
</table>
</asp:Content>
