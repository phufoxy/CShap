<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="CTHDDelete.aspx.cs" Inherits="QLTapHoaNTLTGroup.CTHDDelete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <table class="auto-style1">
        ...
        <tr>
            ...
            <td style="width: 266px">
                <asp:DropDownList ID="DropDownList3" runat="server" Enabled="False" Height="16px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
