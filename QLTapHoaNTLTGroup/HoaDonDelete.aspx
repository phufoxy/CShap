<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="HoaDonDelete.aspx.cs" Inherits="QLTapHoaNTLTGroup.HoaDonDelete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td style="width: 346px">
                <asp:TextBox ID="TextBox2" runat="server" TextMode="Date" Width="330px" Enabled="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 143px; text-align: right"><strong><em>
