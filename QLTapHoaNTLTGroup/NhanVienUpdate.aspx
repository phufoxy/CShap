<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="NhanVienUpdate.aspx.cs" Inherits="QLTapHoaNTLTGroup.NhanVienUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td style="width: 314px">
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/anh/sửa.png" OnClick="ImageButton1_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
