<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="KhachHangDelete.aspx.cs" Inherits="QLTapHoaNTLTGroup.KhachHangDelete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td style="width: 319px">
            <asp:TextBox ID="TextBox2" runat="server" Width="306px" Enabled="False"></asp:TextBox>
        </td>
        <td rowspan="8">
    ...
    <tr>
        ...
        <td class="call-to-action" style="width: 319px; text-align: left;">
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/anh/delete.png" Width="26px" OnClick="ImageButton1_Click" />
        </td>
    </tr>
</table>
</asp:Content>
