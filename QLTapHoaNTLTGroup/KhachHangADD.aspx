<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="KhachHangADD.aspx.cs" Inherits="QLTapHoaNTLTGroup.KhachHangADD" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td style="text-align: right" colspan="3">
            <asp:GridView ID="GridView1" runat="server"   CssClass="Grid"   CaptionAlign="Bottom" CellPadding="4" ForeColor="#333333" GridLines="None" Height="100%" HorizontalAlign="Center" Width="96%" AllowPaging="True" AllowSorting="True" OnSorting="GridView1_Sorting" PageSize="5" EmptyDataText="Không Có Dữ Liệu Nào" Font-Size="Medium" OnPageIndexChanging="GridView1_PageIndexChanging">
    ...
    <tr>
        ...
        <td class="call-to-action" style="width: 319px; text-align: left;">
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/anh/add.png" Width="26px" OnClick="ImageButton1_Click" />
        </td>
    </tr>
</table>
