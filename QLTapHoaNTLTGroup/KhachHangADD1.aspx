<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KhachHangADD1.aspx.cs" Inherits="QLTapHoaNTLTGroup.KhachHangADD1" %>
...
<body>
    ...
    <div id="container">	
        ...
        <section>
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        <td class="call-to-action">
                            &nbsp;</td>
                        <td class="call-to-action">
                            <asp:Label ID="Label1" runat="server" CssClass="auto-style4" Text="Mã Khách Hàng"></asp:Label>
                        </td>
                        <td class="call-to-action">
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td class="call-to-action">
                            &nbsp;</td>
                        <td class="call-to-action">
                            <asp:Label ID="Label2" runat="server" CssClass="auto-style4" Text="Tên Khách Hàng"></asp:Label>
                        </td>
                        <td class="call-to-action">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:TextBox ID="TextBox2" runat="server" placeholder="Enter TenKH"  required></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="call-to-action">
                            &nbsp;</td>
                        <td class="call-to-action">
                            <asp:Label ID="Label3" runat="server" CssClass="auto-style4" Text="Giới Tính"></asp:Label>
                        </td>
                        <td class="call-to-action">
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td class="call-to-action">
                            &nbsp;</td>
                        <td class="call-to-action">
                            <asp:Label ID="Label4" runat="server" CssClass="auto-style4" Text="Năm Sinh"></asp:Label>
                        </td>
                        <td class="call-to-action">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:TextBox ID="TextBox4" runat="server" placeholder="Enter NamSinh"  required TextMode="Date"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="call-to-action">
                            &nbsp;</td>
                        <td class="call-to-action">
                            <asp:Label ID="Label5" runat="server" CssClass="auto-style4" Text="Địa Chỉ"></asp:Label>
                        </td>
                        <td class="call-to-action">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:TextBox ID="TextBox5" runat="server" placeholder="Enter DiaChi"  required></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="call-to-action">
                            &nbsp;</td>
                        <td class="call-to-action">
                            <asp:Label ID="Label6" runat="server" CssClass="auto-style4" Text="SDT"></asp:Label>
                        </td>
                        <td class="call-to-action">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:TextBox ID="TextBox6" runat="server" placeholder="Enter SDT"  required></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="call-to-action">
                            &nbsp;</td>
                        <td class="call-to-action">
                            <asp:Label ID="Label7" runat="server" CssClass="auto-style4" Text="Email"></asp:Label>
                        </td>
                        <td class="call-to-action">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:TextBox ID="TextBox7" runat="server" placeholder="Enter Email"  required></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="auto-style5">
                            &nbsp;</td>
                        <td class="auto-style5">
                            <asp:Label ID="Label8" runat="server" CssClass="auto-style4" Text="Điểm"></asp:Label>
                        </td>
                        <td class="auto-style5">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="auto-style3">
                            &nbsp;</td>
                        <td class="auto-style3">
                            <asp:TextBox ID="TextBox8" runat="server" placeholder="Enter Diem"  required></asp:TextBox>
                        </td>
                        <td class="auto-style3">
                            &nbsp;</td>
                    </tr>
         ...
         <section id="footer">
            <div>
                <p style="color:white;">Bán Hàng Online</p>
            </div>
        </section>
    </form>
</body>
