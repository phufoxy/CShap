<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="HangHoaADD.aspx.cs" Inherits="QLTapHoaNTLTGroup.HangHoaADD" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        <tr>
            <td class="call-to-action" colspan="3">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="5" Width="100%" CaptionAlign="Bottom" EmptyDataText="Không Có Dữ Liệu " Font-Italic="False" HorizontalAlign="Center" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">
