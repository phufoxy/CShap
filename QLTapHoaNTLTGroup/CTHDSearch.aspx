<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="CTHDSearch.aspx.cs" Inherits="QLTapHoaNTLTGroup.CTHDSearch" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table class="auto-style1">
        ...
        <tr>
            ...
            <td style="width: 266px">
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/anh/active-search.png" OnClick="ImageButton1_Click" Height="41px" />
            </td>
        </tr>
    </table>
</asp:Content>
