<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="NhanVienADD.aspx.cs" Inherits="QLTapHoaNTLTGroup.NhanVienADD" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        <tr>
            <td colspan="3" class="call-to-action">
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="100%" Width="100%" AllowPaging="True" AllowSorting="True" BorderStyle="None" EmptyDataText="Không Có Dữ Liệu" HorizontalAlign="Center" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting" PageSize="5">
        ...
        <tr>
            ...
            <td style="width: 314px">
                <asp:TextBox ID="TextBox3" runat="server" Width="302px" TextMode="Date"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 259px; text-align: right"><strong><em>
