<%@ Page Title="" Language="C#" MasterPageFile="~/QLFORM.Master" AutoEventWireup="true" CodeBehind="HoaDonSearch.aspx.cs" Inherits="QLTapHoaNTLTGroup.HoaDonSearch" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        <tbody class="call-to-action" style="text-align: left">
        <tr>
        ...
        <tr>
            ...
            <td style="width: 346px">
                <asp:TextBox ID="TextBox1" runat="server" Width="330px" Enabled="False"></asp:TextBox>
            </td>
            <td rowspan="5">
        ...
        <tr>
            ...
            <td style="width: 346px">
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/anh/active-search.png" Height="36px" OnClick="ImageButton1_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
